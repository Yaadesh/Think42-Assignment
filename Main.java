...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (FileReader reader = new FileReader("/home/yaadesh/Desktop/user_data.json"))
        {
            ...
            int similarityScore = compareTwoUsers(USER_D_KEY,(JSONObject)userData.get(USER_A_KEY),map);
...
public static int compareTwoUsers(String userB, JSONObject userA, HashMap<String,HashMap<String,HashSet>> map){
        JSONObject jsonObjectUserA = userA;
